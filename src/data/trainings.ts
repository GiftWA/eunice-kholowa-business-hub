...
export const trainings: Training[] = [
  ...
  },
  {
    ...
    slug: "cassava-chips",
    title: "Cassava Chips",
    description: "Make crunchy cassava chips for sale.",
    price: 15000,
    category: "Snacks & Food",
    image: "/images/trainings/cassava-chips.jpg",
    duration: "1 Day",
    whatYouLearn: [
      "Selecting and preparing cassava correctly",
      "Slicing techniques for even chips",
      "Frying for maximum crunch",
      "Seasoning and flavouring options",
      "Packaging for retail and market stalls",
      "Building a regular customer base",
    ],
  },
  {
    ...
    slug: "cheula",
    title: "Cheula",
    description: "Make traditional cheula snacks for profit.",
    price: 15000,
    category: "Snacks & Food",
    image: "/images/trainings/cheula.jpg",
    duration: "1 Day",
    whatYouLearn: [
      "Traditional preparation methods",
      "Getting the right texture and taste",
      "Packaging to keep cheula fresh",
      "Pricing for market and school sales",
      "Growing a loyal customer base",
    ],
  },
  {
    id: "39",
    slug: "irish-potato-chips",
    title: "Irish Potato Chips",
    description: "Produce crispy Irish potato chips for sale.",
    price: 15000,
    category: "Snacks & Food",
    image: "/images/trainings/irish-potato-chips.jpg",
    duration: "1 Day",
    whatYouLearn: [
      "Selecting the right potatoes",
      "Slicing and preparing potatoes correctly",
      "Frying techniques for consistent crispiness",
      "Salt and seasoning options",
      "Packaging for freshness and appeal",
      "Selling at markets, shops, and schools",
    ],
  },
  {
    id: "40",
    ...
    description: "Produce refreshing tamarind juice drinks for sale.",
    price: 15000,
    category: "Snacks & Food",
    image: "/images/trainings/tamarind-juice.jpg",
    duration: "1 Day",
    whatYouLearn: [
      "Sourcing and preparing tamarind",
      "Extracting and processing the juice",
      "Getting the right sweetness and taste",
      "Bottling and sealing for freshness",
      "Pricing and selling in your community",
